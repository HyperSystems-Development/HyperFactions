...
### Fixed
- **Null-safe `getTransform()` for prerelease compatibility** — `PlayerRef.getTransform()` can return null during world transitions in prerelease builds; added null checks in:
