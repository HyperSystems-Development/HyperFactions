...
public class VaultEconomyProvider {
   ...
   * Calls Economy.getName() via reflection.
   *
   * @return the economy plugin name, or null if unavailable
   */
  ...
  /**
   * Gets a player's balance from VaultUnlocked as a BigDecimal.
   *
   * @param playerUuid the player's UUID
   * @return the balance, or BigDecimal.ZERO if unavailable
   */
  @NotNull
   ...
   *
   * @param playerUuid the player's UUID
   * @return the balance as double, or 0.0 if unavailable
   */
   ...
   *
   * @param playerUuid the player's UUID
   * @param amount     the amount to check (as double, converted to BigDecimal)
   * @return true if the player has sufficient funds
   */
   ...
   *
   * @param playerUuid the player's UUID
   * @param amount     the amount to withdraw (as double, converted to BigDecimal)
   * @return true if the withdrawal succeeded
   */
   ...
   *
   * @param playerUuid the player's UUID
   * @param amount     the amount to deposit (as double, converted to BigDecimal)
   * @return true if the deposit succeeded
   */
