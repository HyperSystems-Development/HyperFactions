...
public class AdminConfigPage extends InteractiveCustomUIPage<AdminConfigData> {
  ...
  public void build(Ref<EntityStore> ref, UICommandBuilder cmd,
    ...
    cmd.set("#PageTitle.Text", HFMessages.get(playerRef, AdminGuiKeys.AdminGui.GUI_TITLE_CONFIG));
    cmd.set("#ComingSoon.Text", HFMessages.get(playerRef, AdminGuiKeys.AdminGui.GUI_CONFIG_HEADING));
    cmd.set("#ComingSoonSub.Text", HFMessages.get(playerRef, AdminGuiKeys.AdminGui.GUI_COMING_SOON));
    cmd.set("#Description.Text", HFMessages.get(playerRef, AdminGuiKeys.AdminGui.GUI_CONFIG_DESC1));
    cmd.set("#Description2.Text", HFMessages.get(playerRef, AdminGuiKeys.AdminGui.GUI_CONFIG_DESC2));
  }
