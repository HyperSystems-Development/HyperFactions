...
public interface EconomyAPI {
   ...
   * @return the balance, or BigDecimal.ZERO if faction not found
   */
  @NotNull
  BigDecimal getFactionBalance(@NotNull UUID factionId);
   ...
   */
  boolean hasFunds(@NotNull UUID factionId, @NotNull BigDecimal amount);
