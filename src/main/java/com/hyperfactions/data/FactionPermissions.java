...
public final class FactionPermissions {
  ...
  public static final String SUFFIX_CRATE_USE = "CrateUse";
  ...
  public static final String ALLY_CRATE_USE = "allyCrateUse";
  ...
  public static final String MEMBER_CRATE_USE = "memberCrateUse";
  ...
  public static boolean isParentFlag(@NotNull String flagName) {
    if (MOB_SPAWNING.equals(flagName)) {
      return true;
    }
    for (String level : ALL_LEVELS) {
      if (flagName.equals(level + SUFFIX_INTERACT)) {
        return true;
      }
    }
    return false;
  ...
  // Accessor methods for commonly used flags
  /** Pvp Enabled. */
  public boolean pvpEnabled() {
    return get(PVP_ENABLED);
  }

  /** Officers Can Edit. */
  public boolean officersCanEdit() {
    return get(OFFICERS_CAN_EDIT);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof FactionPermissions other)) {
      return false;
    }
