 ...
 *
 * <p>Threading note: Teleport execution must happen on the world thread.
...
public class TeleportManager {
  ...
  public static class PendingTeleport {
    ...
    /** Checks if tagged. */
    public Supplier<Boolean> isTagged() {
      return isTagged;
    }

    public @Nullable String successMessage() {
