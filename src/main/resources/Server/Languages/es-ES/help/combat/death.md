...
|--------|-----------------|
| Muerte (cualquier causa) | -1.0 |
| Regeneracion en linea | +0.1 por minuto |
| Desconexion en combate | -1.0 (muerto) |

## Escenarios de Ejemplo

*5 miembros a 10.0 de poder cada uno = 50 total, 20 reclamos.*
*Un miembro muere dos veces: 8.0 de poder, total de faccion 48.*
*Tres miembros mueren una vez cada uno: el total baja a 47.*

>[!WARNING] Si el poder de tu faccion cae por debajo de tu cantidad de reclamos, los enemigos pueden sobrereclamar tu territorio.
