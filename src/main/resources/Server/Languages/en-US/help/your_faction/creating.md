...
| **Characters** | Letters, numbers, and spaces only (alphanumeric) |
...
>[!TIP] After creating, your first priorities should be: invite friends with `/f invite <player>`, find a base location, and claim it with `/f claim`.
